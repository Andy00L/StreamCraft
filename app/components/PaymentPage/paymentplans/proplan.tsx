import { createCustomerPortal, createSubscription } from "@/app/Functions";
  ...
  return (
    <div className="px-12 py-6 sm:px-4 sm:py-4 md:px-6 md:py-4 flex flex-col relative rounded-2xl">
      <div className="text-left">
        <div className="flex">
          <p className="text-xl mr-2 text-green-600">Monthly</p>
        </div>
        ...
        <div className="mt-6 mb-6">
          ...
          <p className="text-lg mt-2 opacity-70">billed per month</p>
        </div>
      </div>
      {user ? (
        <SubscriptionButtons />
      ...
      <div className="my-3 mx-2">
        <div className="text-xl">3 000</div>
    ...
    <>
      {userprisma?.interval === "year" ? (
        ...
        <form
          ...
          className="w-full h-11 flex items-center justify-center rounded-lg drop-shadow px-8 shadow cursor-pointer active:scale-95 hover:brightness-110 transition-all bg-gradient-to-t "
        >
          <input hidden name="Subscription" value="monthly" readOnly />
